...
namespace GYMMAX
{
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            arch.WriteLine("<html>INFORME DE INSCRIPCIONES<br><br>");
            arch.WriteLine("<table border=1 cellspacing=0>");
            arch.WriteLine("<tr><td>id_insc</td><td>id_cliente</td><td>id_plan</td><td>id_usuario</td><td>fecha_reg</td><td>fecha_fin</td></tr>");
        ...
        string archivo = Directory.GetCurrentDirectory() + "\\informedeinscripciones.html";

        private void Form6_Load(object sender, EventArgs e)
        {
            if (Form1.idioma == 2)
            {
                this.Text = "Inscriptions report";
